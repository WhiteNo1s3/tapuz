...
- **סטודיו ערכות הנושא** — 15 מראות מוכנים שהם ערכות שלמות (גופני Google בעברית, רקעי דף, סגנון כפתורים, שלד ועור), ו**מעצב/ת ערכות ב-AI**: מתארים את האתר שבדמיונכם, מעתיקים פרומפט לצ׳אט חדש, מדביקים את התשובה — הערכה נכנסת לספרייה, **הקנבס מראה אותה על האתר האמיתי** לפני השמירה, ולחיצה אחת מחילה. ייבוא סלחני (קובץ / JSON / תשובת צ׳אט עם פטפוט), ואפקטים שמקומפלים לפני שהם נקלטים
