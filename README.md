...
**גרסה נוכחית: v1.62-alpha** · המפה המלאה: [docs/ROADMAP.md](docs/ROADMAP.md)
...
- **ניווט חלק** — לחיצה על תפריט הצד מחליפה רק את התוכן; הסרגל הקבוע לא נטען מחדש ולא קופץ (עם נפילה חלקה לרענון מלא בכל תקלה)
