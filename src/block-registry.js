...
const BLOCK_REGISTRY = [
  ...
  },
  {
    ...
    bodyClass: 'none',
    childrenOf: null,
    hintHe: 'שורת כותב — שם, תפקיד, תמונה, תאריך',
    params: [
      { name: 'name', bentmlParam: 'name', labelHe: 'שם', type: 'string', required: true },
      { name: 'role', bentmlParam: 'role', labelHe: 'תפקיד', type: 'string' },
      { name: 'image', bentmlParam: 'image', labelHe: 'תמונה', type: 'media' },
      { name: 'url', bentmlParam: 'url', labelHe: 'קישור', type: 'url' },
      { name: 'time', bentmlParam: 'time', labelHe: 'תאריך', type: 'string' }
    ],
    textField: null,
    seed: { name: 'דנה כהן', role: 'עורכת', time: '9.9.2026', url: '/author/dana', image: '/demo/tile-1.svg' }
  },
  {
    type: 'tags',
    keyword: 'TAGS',
