...
| Main tip | v2.56 (Geppetto — PR #46, draft until its independent review) on top of v2.55 (the card gateway), v2.54 (class names on every module) and v2.53 (the store) — `git log -1 origin/main` |
